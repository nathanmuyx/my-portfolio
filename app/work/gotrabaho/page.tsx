              ...
              <div className="grid grid-cols-2 gap-3 mt-8">
                ...
                <div className="relative rounded-xl bg-[#0a0a0a] overflow-hidden" style={{ aspectRatio: "253 / 540" }}>
                  ...
                  <div className="absolute z-0" style={{ left: "18.2%", top: "5.6%", width: "63.6%", height: "62.8%" }}>
                    <Image src="/images/gotrabaho/onboard-back.png" alt="GoOnboard step 1" fill className="object-cover" loading="lazy" sizes="25vw" />
                  </div>
                  <div className="absolute z-10 shadow-[0px_-10px_33px_rgba(0,0,0,0.25)]" style={{ left: "9.1%", top: "14.4%", width: "81.8%", height: "80.7%" }}>
                    <Image src="/images/gotrabaho/onboard-front.png" alt="NBI Clearance verification" fill className="object-cover" loading="lazy" sizes="25vw" />
                  </div>
                </div>
                ...
                <div className="relative rounded-xl bg-[#0a0a0a] overflow-hidden" style={{ aspectRatio: "253 / 540" }}>
                  ...
                  <div className="absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" style={{ width: "80%", height: "80%" }}>
                    <Image src="/images/gotrabaho/profile-portfolio.png" alt="Verified worker profile with portfolio" fill className="object-cover" loading="lazy" sizes="25vw" />
                  </div>
                </div>
                ...
                <div className="relative rounded-xl bg-[#0a0a0a] overflow-hidden" style={{ aspectRatio: "253 / 540" }}>
                  ...
                  <div className="absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-[5px] border-white/50 rounded-[14px] overflow-hidden" style={{ width: "80%", height: "80%" }}>
                    <Image src="/images/gotrabaho/profile-reviews.png" alt="Worker profile with feedback and ratings" fill className="object-cover" loading="lazy" sizes="25vw" />
                  </div>
                </div>
                ...
                <div className="relative rounded-xl bg-[#0a0a0a] overflow-hidden" style={{ aspectRatio: "253 / 540" }}>
                  ...
                  <div className="absolute z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border-[5px] border-white/50 rounded-[14px] overflow-hidden" style={{ width: "78%", height: "79%" }}>
                    <Image src="/images/gotrabaho/jobs-unverified.png" alt="Jobs listing with unverified warning" fill className="object-cover" loading="lazy" sizes="25vw" />
                  </div>
                </div>
              </div>
            </div>
