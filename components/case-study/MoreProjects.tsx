...
function StrategicVisionzMockup() {
  return (
    <>
      ...
      >
        <LazyImage src="/images/strategic-visionz/homepage.webp" alt="" fill className="object-cover object-top" loading="lazy" sizes="320px" />
      </div>
    </>
  );
}
  ...
  return (
    <>
      ...
      <div className="absolute border-[3px] border-white/20 rounded-[8px] overflow-hidden" style={{ left: "18.5%", top: "21%", width: "62.3%", aspectRatio: "404 / 226", zIndex: 1 }}>
        <LazyImage src="/images/typid/aisen-3.webp" alt="" fill className="object-cover object-top" loading="lazy" sizes="320px" />
      </div>
      {/* Middle card */}
      <div className="absolute border-[3px] border-white/20 rounded-[8px] overflow-hidden" style={{ left: "15.4%", top: "30%", width: "69.1%", aspectRatio: "448 / 250", zIndex: 2 }}>
        <LazyImage src="/images/typid/Himaya-2.webp" alt="" fill className="object-cover object-top" loading="lazy" sizes="320px" />
      </div>
      {/* Front card */}
      <div className="absolute border-[3px] border-white/20 rounded-[8px] overflow-hidden" style={{ left: "12.3%", top: "41%", width: "75.3%", aspectRatio: "488 / 274", zIndex: 3 }}>
        <LazyImage src="/images/typid/homepage-1.webp" alt="" fill className="object-cover object-top" loading="lazy" sizes="320px" />
      </div>
    </>
  );
}
  ...
  return (
    <>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 top-[18%] w-[65%]" style={{ aspectRatio: "236 / 175" }}>
        <LazyImage src="/images/retriever/mockup.webp" alt="" fill className="object-contain" loading="lazy" sizes="320px" />
      </div>
    </>
  );
}
